                    ...
                    <div class="card ">
                        ...
                        <div class="card-content ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <form method="post" action="{{ route('settings.update', [$setting]) }}" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
                                        @csrf
                                        @method('put')
                                        <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('title_uz') ? ' has-danger' : '' }}">
                                                            <input class="form-control" id="input-title_uz" name="title_uz" type="text" placeholder="{{ __('title uz') }}" value="{{ old('title_uz', $setting->title_uz) }}" aria-required="true"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('description_uz') ? ' has-danger' : '' }}">
                                                            <textarea class="form-control" id="input-description_uz" name="description_uz" placeholder="{{ __('description uz') }}">{{ old('description_uz', $setting->description_uz) }}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('content_uz') ? ' has-danger' : '' }}">
                                                            <textarea class="form-control" id="input-content_uz" name="content_uz" placeholder="{{ __('content uz') }}">{{ old('content_uz', $setting->content_uz) }}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('title_en') ? ' has-danger' : '' }}">
                                                            <input class="form-control" id="input-title_en" name="title_en" type="text" placeholder="{{ __('title en') }}" value="{{ old('title_en', $setting->title_en) }}"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('description_en') ? ' has-danger' : '' }}">
                                                            <textarea class="form-control" id="input-description_en" name="description_en" placeholder="{{ __('description en') }}">{{ old('description_en', $setting->description_en) }}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('content_en') ? ' has-danger' : '' }}">
                                                            <textarea class="form-control" id="input-content_en" name="content_en" placeholder="{{ __('content en') }}">{{ old('content_en', $setting->content_en) }}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('title_ru') ? ' has-danger' : '' }}">
                                                            <input class="form-control" id="input-title_ru" name="title_ru" type="text" placeholder="{{ __('title ru') }}" value="{{ old('title_ru', $setting->title_ru) }}"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('description_ru') ? ' has-danger' : '' }}">
                                                            <textarea class="form-control" id="input-description_ru" name="description_ru" placeholder="{{ __('description ru') }}">{{ old('description_ru', $setting->description_ru) }}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('content_ru') ? ' has-danger' : '' }}">
                                                            <textarea class="form-control" id="input-content_ru" name="content_ru" placeholder="{{ __('content ru') }}">{{ old('content_ru', $setting->content_ru) }}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="form-group{{ $errors->has('key') ? ' has-danger' : '' }}">
                                                        <input class="form-control" id="input-key" name="key" type="text" placeholder="{{ __('Key') }}" value="{{ old('key', $setting->key) }}"/>
                                                        @if ($errors->has('key'))
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <img src="{{ asset('storage') .'/'. $setting->icon }}" alt="" style="width: 200px">
